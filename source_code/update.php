...
<body>
    ...
    <main>
        ...
        <form action="submit_update.php" method="post" enctype="multipart/form-data">
            ...
            <p>NIM <br><input type="text" name="nim" value="<?= $data['nim']?>"></p>
            <p>Nama <br><input type="text" name="nama" value="<?= $data['nama']?>"></p>
            <p>Semester <br><input type="number" name="semester" step="any" value="<?= $data['semester']?>"></p>
            <p>Divisi <br>
                <select name="divisi">
                <?php
                    $div_id = $card["id_divisi"];
                    $div_nama = $card["nama_divisi"];
            ...
            <p>Jabatan <br>
                <select name="jabatan">
                <?php
                    $bid_id = $card["id_bidang"];
                    $bid_nama = $card["jabatan"];
